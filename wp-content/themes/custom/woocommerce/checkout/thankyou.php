...
?>
<br>
<div class="woocommerce-order my-thank-you-page">
	...
	?>
		...
		<?php endif; ?>
		<?php if ($order->data['payment_method'] == 'bacs') : ?>
			<div class="my-bank-description">
				Vui lòng chuyển khoản với nội dung "ORDER <?= $order->id ?>" 
			</div><br><br>
		<?php endif ?>
