...
function woolentor_pro_get_widget_from_section($section, $widget_name){
    ...
    foreach($section['elements'] as $column){
        // Fix - Suddenly noticed that From 21112022 for multi checkout style 2 clumns elements were empty
        // this is whey this code is added
        if( isset($column['widgetType']) && $column['widgetType'] == $widget_name ){
            return $column;
        }
