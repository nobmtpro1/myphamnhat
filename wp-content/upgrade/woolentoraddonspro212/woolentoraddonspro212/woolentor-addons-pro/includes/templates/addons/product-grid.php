                ...
                <div class="ht-product-action-3">
                    <ul>
                        ...
                        <li class="wlgrid-quickview">
                            <a href="#" class="ht-product-action-icon-2 woolentorquickview" data-quick-id="<?php the_ID();?>" <?php echo wc_implode_html_attributes( ['aria-label'=>$product->get_title()] ); ?>><i class="sli sli-magnifier"></i></a>
                        </li>
                    </ul>
                </div>
