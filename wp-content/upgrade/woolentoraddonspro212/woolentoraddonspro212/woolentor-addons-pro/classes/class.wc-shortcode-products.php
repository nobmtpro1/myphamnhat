    ...
    class WooLentor_WC_Shortcode_Products extends WC_Shortcode_Products {
        ...
        protected function grid_row_attr( $loop_col ){
            ...
            if( isset( $settings['slider_on'] ) && $settings['slider_on'] === 'yes' ){
                ...
                $slider_settings = isset( $settings['slider_settings'] ) ? $settings['slider_settings'] : array_merge( $slider_settings, $slider_responsive_settings );
                ...
                if( isset( $settings['tab_menu'] ) && 'yes' === $settings['tab_menu'] ):
                    ?>
                        <ul id="wl-shop-tab-links-<?php echo $settings['tabuniqid']; ?>" class="wl-shop-tab-links">
                            <li><a href="#grid-<?php echo $settings['tabuniqid']; ?>" data-tabvalue="grid_view" class="<?php if( $settings['woolentor_product_view_mode'] == 'grid' ){ echo 'htactive'; } ?>" aria-label="<?php echo esc_attr__('Grid','woolentor-pro') ?>" rel="<?php echo esc_attr__('nofollow','woolentor-pro'); ?>"><i class="sli sli-grid"></i></a></li>
                            <li><a href="#list-<?php echo $settings['tabuniqid']; ?>" data-tabvalue="list_view" class="<?php if( $settings['woolentor_product_view_mode'] == 'list' ){ echo 'htactive'; } ?>" aria-label="<?php echo esc_attr__('List','woolentor-pro') ?>" rel="<?php echo esc_attr__('nofollow','woolentor-pro'); ?>"><i class="sli sli-menu"></i></a></li>
                        </ul>
                    <?php
                endif;
            endif;
